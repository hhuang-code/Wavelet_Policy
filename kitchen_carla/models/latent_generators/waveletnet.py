...
import models.libraries.waveletnet.model as waveletnet_model
import models.libraries.waveletnet.trainer as waveletnet_trainer
...
class WaveletNet(latent_generator.AbstractLatentGenerator):
    ...
    def get_latent_and_loss(
        ...
        if self.predict_offsets:
            # todo
            output, _, d_loss, s_loss = self.model(obs_rep)     # (b, ws, obs_dim), input; (b, ws, n_bins + n_bins * act_dim), output
