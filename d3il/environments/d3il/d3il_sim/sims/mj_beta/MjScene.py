...
class MjScene(Scene):
    ...
    def _setup_scene(self):
        ...
        if self.render_mode == self.RenderMode.HUMAN:
            ...
            self.viewer = Viewer(self.model, self.data, image_path=self.image_path)  # Renderer, added by Hao
